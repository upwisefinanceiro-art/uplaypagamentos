                ...
                <div className="space-y-4 pt-2">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      const valor = `R$ ${parseFloat(chargeValue).toFixed(2).replace(".", ",")}`;
                      const venc = new Date(chargeDueDate + "T12:00:00").toLocaleDateString("pt-BR");
                      const link = chargeResult.invoice_url || "";
                      const pix = chargeResult.pix_copy_paste || "";
                      let msg = `Olá, ${nome}! 👋\n\nSegue sua cobrança:\n💰 Valor: *${valor}*\n📅 Vencimento: *${venc}*\n\n`;
                      if (link) msg += `🔗 Pague pelo link:\n${link}\n\n`;
                      if (pix) msg += `Ou copie o código PIX:\n\`\`\`${pix}\`\`\`\n\n`;
